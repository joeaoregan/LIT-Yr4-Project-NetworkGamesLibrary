...
//void initWinsock();																				// Moved to JOR_NET - Init windows networking functionality
//struct sockaddr_in intServerAddr(char *ip);
//struct sockaddr_in initClientAddr();
//int findClientIDNumber(struct sockaddr_in newCliAddr, struct sockaddr_in clientsList[], int size);	
